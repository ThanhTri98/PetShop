...
//                       uid,  pwd,  fullName,  email,  gender,  dateOfBirth,  phoneNumber,  avatar
    ...
    public void updateCoinsToSession(String uid, long values) {
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put(SessionManager.KEY_COINS, String.valueOf(values + sessionManager.getUserDetail().getCoins()));
        Log.e("UserDAL290 - ", uid + values);
        sessionManager.updateSessionInfo(hashMap);
